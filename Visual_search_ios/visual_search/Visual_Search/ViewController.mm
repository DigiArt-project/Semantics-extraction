...
{
    //_searchViewController = [[SearchViewController alloc]  initWithNibName:@"SearchView_iPad" bundle:nil];
    //_searchViewController.delegate = self;
    //_searchViewNavigationController = [[UINavigationController alloc] initWithRootViewController:_searchViewController];
...
- (IBAction)onParametersButtonPressed:(id)sender {
