...
public:
    ...
    /** add more points to a point cloud
     * @param cloud
     return new upsampled point cloud
     */
    static pcl::PointCloud<PointType>::Ptr upsampling(const pcl::PointCloud<PointType>::Ptr & cloud, float radius_search = 0.03f, float upsampling_radius = 0.03f,float upsampling_step_size = 0.03f);
